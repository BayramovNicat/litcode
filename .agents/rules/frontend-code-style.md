...
- Prefer passing runes or reactive getter functions into `html` templates over manually syncing DOM text, attributes, or classes.
- Do not introduce ad-hoc stores, observers, or module-level mutable UI state when the provided runes express the state clearly.
